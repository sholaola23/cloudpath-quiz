    ...
    <div className="min-h-screen bg-bg-primary">
      <div className="max-w-2xl mx-auto px-6 py-12 sm:py-16">
        ...
        >
          ...
          <blockquote className="bg-bg-card border border-bg-border rounded-xl p-6 relative overflow-hidden">
            <div
              className="absolute left-0 top-0 bottom-0 w-1 rounded-l-xl"
              style={{ backgroundColor: accentColour }}
            />
        ...
        >
          <div className="flex flex-col gap-3">
            <a
              ...
              className="w-full flex items-center justify-center px-6 py-4 rounded-xl font-semibold text-white text-sm sm:text-base transition-all duration-200 hover:shadow-lg"
              style={{ backgroundColor: accentColour }}
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center px-6 py-4 rounded-xl border text-sm sm:text-base font-medium bg-transparent hover:bg-bg-hover transition-all duration-200"
